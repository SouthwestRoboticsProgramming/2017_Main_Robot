...
//		} else {
//			// Is this OFF?
//			getLightsSubsystem().setLeft(getRightJoystick().getRawButton(LIGHT_BLINK_LEFT_BUTTON));
//			getLightsSubsystem().setRight(getRightJoystick().getRawButton(LIGHT_BLINK_RIGHT_BUTTON));
//		}
	}
