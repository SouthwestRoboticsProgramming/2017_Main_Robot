...
public class SimpleShiftingGearbox implements SpeedController {
	...
	private double shifterThreshold;
	private double shiftDrop;
	private boolean shifterInverted;
	private boolean inverted = false;
	private XSolenoidWrapper shifter;
	private SpeedController controller1;
	private SpeedController controller2;
	private SpeedController controller3;

	public SimpleShiftingGearbox(SpeedController c1, SpeedController c2, SpeedController c3, XSolenoidWrapper solenoid, double threshold, double drop,
			boolean solenoidInverted) {
		controller1 = c1;
		controller2 = c2;
		controller3 = c3;
